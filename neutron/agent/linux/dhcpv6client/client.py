...
from neutron.agent.linux.dhcpv6client import subnetpd
...
class DHCPV6Client(Thread):

    def __init__(self):
        super(DHCPV6Client, self).__init__()
        self.pd_clients = {}
        try:
            ...
            LOG.warn(_("Failed to read existing subnet info from system!"))
